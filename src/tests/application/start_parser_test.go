...
func TestParseStartArgs(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:         []string{"start", "--target", "codex", "--title", "Northstar", "--description", "Project context", "--doc", "README.md", "--doc", "docs/vision.md", "--output", "/tmp/project", "--force"},
			expectTarget: "codex",
			expectTitle:  "Northstar",
		...
		},
		{
			...
			args:           []string{"start", "--interactive", "--target", "codex", "--title", "Northstar", "--description", "Project context", "--doc", "README.md"},
			expectTarget:   "codex",
			expectTitle:    "Northstar",
			expectDesc:     "Project context",
